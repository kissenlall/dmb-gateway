...
import static net.activia.dmb.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.activia.dmb.DmbGatewayApp;
import net.activia.dmb.config.Constants;
import net.activia.dmb.domain.Authority;
import net.activia.dmb.domain.User;
import net.activia.dmb.repository.AuthorityRepository;
import net.activia.dmb.repository.UserRepository;
import net.activia.dmb.security.AuthoritiesConstants;
import net.activia.dmb.service.UserService;
import net.activia.dmb.service.dto.PasswordChangeDTO;
import net.activia.dmb.service.dto.UserDTO;
import net.activia.dmb.web.rest.vm.KeyAndPasswordVM;
import net.activia.dmb.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = DmbGatewayApp.class)
